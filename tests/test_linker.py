...
@pytest.mark.parametrize("test_input,expected", [
    ("test", "test"), ("test test", "test test"), ("test_test", "test"),
    ("test1", "test"), ("test22_test3", "test"), ("", ""), (None, "")])
...
def test_get_all_possible_names_from_record(nolen_record, nolen_possible_names):
    assert linker.get_all_possible_names_from_record(
...
@pytest.mark.parametrize("input_text, name_id, expected", [
